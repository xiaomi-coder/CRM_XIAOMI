      ...
      questions: [
        {
          ...
          options: ['A) an aircraft', 'B) a printing press', 'C) a steam engine'],
          answer: 'C',
        },
        {
          type: 'multiple_choice',
          text: 'The workshop demonstrations take place',
          options: ['A) every hour', 'B) twice a day', 'C) by appointment only'],
          answer: 'B',
        },
        {
          type: 'multiple_choice',
          text: 'Children under twelve must',
          options: ['A) pay a reduced entry fee', 'B) be accompanied by an adult', 'C) join a guided tour'],
          answer: 'B',
        },
        { type: 'matching_features', text: 'the aircraft', options: ['@Where can each of the following be found? Choose A, B or C.', 'A) in the entrance hall', 'B) on the first floor', 'C) at the far end of the site'], answer: 'A' },
        { type: 'matching_features', text: 'the bridge gallery', answer: 'B' },
        { type: 'matching_features', text: 'the volunteers restoring machinery', answer: 'C' },
        { type: 'note_completion', text: 'The building was originally a railway ________.', options: ['@Complete the notes below.'], answer: 'workshop' },
        ...
        { type: 'note_completion', text: 'The museum shop closes ________ minutes before the museum does.', answer: '30|thirty' },
      ],
    },
    {
      sectionNumber: 3,
      ...
      questions: [
        {
          type: 'multiple_choice',
          text: 'Their project involves designing',
          options: ['A) a footbridge', 'B) a wind turbine', 'C) a road bridge'],
          answer: 'A',
        },
        {
          type: 'multiple_choice',
          text: 'The main constraint on the design is',
          options: ['A) the cost', 'B) the timescale', 'C) the span required'],
          answer: 'C',
        },
        {
          type: 'multiple_choice',
          text: 'The woman gives priority to a design that is',
          options: ['A) the most impressive to look at', 'B) the easiest to maintain', 'C) the quickest to erect'],
          answer: 'B',
        },
        { type: 'matching_features', text: 'It would be quicker to erect.', options: ['@Which design does each statement apply to? Choose A, B or C.', 'A) the cable-stayed design', 'B) the steel arch', 'C) neither design'], answer: 'A' },
        { type: 'matching_features', text: 'Its components need regular inspection and eventual replacement.', answer: 'A' },
        { type: 'matching_features', text: 'It will still be standing even if nobody attends to it.', answer: 'B' },
        { type: 'sentence_completion', text: 'The bridge must span ________ metres in a single span.', options: ['@Complete the sentences below.'], answer: '35|thirty-five' },
        { type: 'sentence_completion', text: 'They will build a scale ________ for the presentation.', answer: 'model' },
        { type: 'sentence_completion', text: 'The design must last at least ________ years with normal maintenance.', answer: '60|sixty' },
