  ...
  listening: [
    ...
    },
    {
      ...
      questions: [
        {
          type: 'multiple_choice',
          text: 'The scheme applies to',
          options: ['A) all households', 'B) businesses only', 'C) flats only', 'D) rural areas only'],
          answer: 'A',
        },
        {
          type: 'multiple_choice',
          text: 'Electronic items should be',
          options: ['A) placed in the green bin', 'B) taken to a collection point', 'C) left beside the bin', 'D) posted to the council'],
          answer: 'B',
        },
        {
          type: 'multiple_choice',
          text: 'The most common mistake residents make is',
          options: ['A) using the wrong bag', 'B) including food waste', 'C) not rinsing containers', 'D) putting out bins too early'],
          answer: 'C',
        },
        { type: 'note_completion', text: 'Collections take place every ________ weeks.', answer: 'two' },
        { type: 'note_completion', text: 'Batteries must be placed in a separate ________ bag.', answer: 'clear' },
        { type: 'note_completion', text: 'The recycling centre is open until ________ at weekends.', answer: '6pm' },
        { type: 'note_completion', text: 'Large items require a booked ________.', answer: 'collection' },
        { type: 'note_completion', text: 'The council aims to recycle ________ per cent of waste by 2030.', answer: '65' },
        { type: 'note_completion', text: 'Residents can request a new ________ online.', answer: 'bin' },
        { type: 'note_completion', text: 'Information leaflets are available in ________ languages.', answer: 'six' },
      ],
    },
    {
      sectionNumber: 3,
      ...
      questions: [
        {
          ...
          options: ['A) manufacturing', 'B) office work', 'C) agriculture', 'D) transport'],
          answer: 'B',
        },
        {
          type: 'multiple_choice',
          text: 'The woman thinks their introduction is',
          options: ['A) too long', 'B) too technical', 'C) too negative', 'D) too short'],
          answer: 'B',
        },
        {
          type: 'multiple_choice',
          text: 'They agree to include an interview with',
          options: ['A) a professor', 'B) a company manager', 'C) a factory worker', 'D) a student group'],
          answer: 'B',
        },
        {
          type: 'multiple_choice',
          text: 'The man is concerned about',
          options: ['A) the time limit', 'B) the software', 'C) finding sources', 'D) speaking in public'],
          answer: 'A',
        },
        { type: 'sentence_completion', text: 'The presentation must last ________ minutes.', answer: '15' },
        { type: 'sentence_completion', text: 'They will use no more than ________ slides.', answer: '12' },
        { type: 'sentence_completion', text: 'The woman will prepare the ________ section.', answer: 'conclusion' },
        { type: 'sentence_completion', text: 'They plan to rehearse on ________ evening.', answer: 'Sunday' },
        { type: 'sentence_completion', text: 'Their tutor wants a ________ of sources beforehand.', answer: 'list' },
