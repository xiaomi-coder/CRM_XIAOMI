          ...
          <div className="bg-white rounded-card border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-8 bg-indigo-600 text-white flex justify-between items-center relative overflow-hidden">
               ...
               <div className="relative z-10">
                  <h3 className="text-2xl font-bold italic tracking-tighter mb-2 flex items-center gap-3">
                ...
                {topStudents.map((student, idx) => (
                  <div key={student.id} className="flex items-center justify-between p-4 hover:bg-slate-50 rounded-3xl transition-all group">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <h5 className="font-bold text-slate-800 tracking-tight">{student.name}</h5>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Master Level</p>
                      </div>
                    </div>
                    <div className="bg-amber-50 px-5 py-2.5 rounded-2xl border border-amber-100 flex items-center gap-2 group-hover:scale-105 transition-transform">
                      ...
                      <span className="font-bold text-amber-700 text-lg">{student.coins || 0}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="space-y-8">
          <div className="bg-white p-8 rounded-card border border-gray-100 shadow-sm">
             <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="font-bold text-slate-800 uppercase tracking-tighter text-lg">EduMarket</h3>
             </div>
                    ...
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <p className="text-[10px] font-bold text-amber-600 uppercase tracking-widest">{reward.cost} Coins</p>
                          </div>
                       </div>
                    </div>
                  </div>
