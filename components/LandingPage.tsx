...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="landing-page">
        ...
        <div className="landing-container">
          <div className="landing-footer-grid">
            ...
            <div className="landing-footer-col">
              ...
              <ul>
                <li><a href="https://t.me/bakoev_me" target="_blank">Telegram: @bakoev_me</a></li>
          ...
          <div className="landing-footer-bottom">
            ...
            <div className="landing-footer-socials">
              <a href="https://t.me/bakoev_me" target="_blank" title="Telegram">✈</a>
      ...
      <a className="landing-telegram-float" href="https://t.me/bakoev_me" target="_blank">
