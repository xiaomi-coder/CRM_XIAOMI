...
export const translations = {
  uz: {
    ...
    connected: "Ulangan",
    no_debtors: "Qarzdor o'quvchilar yo'q",
    days_overdue: "kun kechikkan",
    copy_connect_link: "Ulanish havolasi",
    bot_not_connected_hint: "Avval Sozlamalarda Telegram botni ulang",
    telegram_connect_hint: "farzandingiz davomati va to'lovlari haqida xabar olish uchun havolani bosing va Start tugmasini bosing",
  ...
  ru: {
    ...
    status_late: "опоздал",
    status_dismissed: "ушёл домой",
    send_all_message: "Отправить всем",
    dismissed_title: "Урок окончен",
    dismissed_message: "Урок вашего ребёнка закончился, он отправился домой.",
    sent_skipped: "отправлено / пропущено",
    connected: "Подключён",
    ...
    telegram_connect_hint: "нажмите на ссылку и кнопку Start, чтобы получать уведомления о посещаемости и платежах вашего ребёнка",
    download: "Скачать",
    report: "Отчет",
  ...
  en: {
    ...
    status_late: "late",
    status_dismissed: "went home",
    send_all_message: "Send to everyone",
    dismissed_title: "Lesson finished",
    dismissed_message: "Your child's lesson has finished and they are heading home.",
    sent_skipped: "sent / skipped",
    connected: "Connected",
    ...
    telegram_connect_hint: "tap the link and press Start to receive updates about your child's attendance and payments",
    download: "Download",
    report: "Report",
